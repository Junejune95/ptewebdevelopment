(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-modules-manage-promotion-promotion-module"], {
  ...
  function srcAppModulesManagePromotionListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let ListComponent = class ListComponent {
      ...
      deleteClass(data) {
        this.subscription = this._tableService.onDeleteYoutubeLink(data.linkId).subscribe(res => {
          this.getYoutubelink();
        });
      }
...
//# sourceMappingURL=app-modules-manage-promotion-promotion-module-es5.f93acc117e938475c368.js.map