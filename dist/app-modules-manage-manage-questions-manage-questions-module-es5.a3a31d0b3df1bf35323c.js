(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-modules-manage-manage-questions-manage-questions-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesManageManageQuestionsCommentCommentComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesManageManageQuestionsQuestionsQuestionsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesManageManageQuestionsStructureStructureComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesManageManageQuestionsCommentCommentComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesManageManageQuestionsCommentCommentComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    let CommentComponent = class CommentComponent {
      ...
      onSaveOrUpdateEssayComment() {
        ...
        if (this.essayCommentIds.length > 0) {
          for (let i = 1; i <= 4; i++) {
            array.push({
              comment: this.essayCommentForm.get("comment".concat(i)).value,
              _id: this.essayCommentIds[i - 1],
              minScore: Number(this.essayCommentForm.get("minValue".concat(i)).value),
              maxScore: Number(this.essayCommentForm.get("maxValue".concat(i)).value),
              commentType: "ESSAY",
              order: i
            });
          }
  ...
  /***/
  function srcAppModulesManageManageQuestionsManageQuestionsRoutingTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ManageQuestionsRoutingModule", function () {
      return ManageQuestionsRoutingModule;
    });
    /* harmony import */
    ...
    var _app_modules_manage_manage_questions_comment_comment_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @app/modules/manage/manage-questions/comment/comment.component */
    "./src/app/modules/manage/manage-questions/comment/comment.component.ts");
    /* harmony import */


    var _app_modules_manage_manage_questions_questions_questions_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! @app/modules/manage/manage-questions/questions/questions.component */
    "./src/app/modules/manage/manage-questions/questions/questions.component.ts");
    /* harmony import */


    var _app_modules_manage_manage_questions_reslovers_comment_reslover__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @app/modules/manage/manage-questions/reslovers/comment.reslover */
    "./src/app/modules/manage/manage-questions/reslovers/comment.reslover.ts");
    /* harmony import */


    var _app_modules_manage_manage_questions_reslovers_essay_structure_reslover__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! @app/modules/manage/manage-questions/reslovers/essay-structure.reslover */
    "./src/app/modules/manage/manage-questions/reslovers/essay-structure.reslover.ts");
    /* harmony import */


    var _app_modules_manage_manage_questions_structure_structure_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! @app/modules/manage/manage-questions/structure/structure.component */
    ...
    ManageQuestionsRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
      exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]],
      providers: [_app_modules_manage_manage_questions_reslovers_essay_structure_reslover__WEBPACK_IMPORTED_MODULE_6__["EssayStructureResolver"], _app_modules_manage_manage_questions_reslovers_comment_reslover__WEBPACK_IMPORTED_MODULE_5__["CommentResolver"]]
  ...
  /***/
  function srcAppModulesManageManageQuestionsManageQuestionsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ManageQuestionsModule", function () {
      return ManageQuestionsModule;
    });
    /* harmony import */
    ...
    var _app_modules_manage_manage_questions_manage_questions_routing__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! @app/modules/manage/manage-questions/manage-questions-routing */
    "./src/app/modules/manage/manage-questions/manage-questions-routing.ts");
    /* harmony import */
    ...
    var _structure_structure_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    ManageQuestionsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_questions_questions_component__WEBPACK_IMPORTED_MODULE_3__["QuestionsComponent"], _comment_comment_component__WEBPACK_IMPORTED_MODULE_6__["CommentComponent"], _structure_structure_component__WEBPACK_IMPORTED_MODULE_7__["StructureComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _app_modules_manage_manage_questions_manage_questions_routing__WEBPACK_IMPORTED_MODULE_4__["ManageQuestionsRoutingModule"], _app_shared_basic_components_basic_module__WEBPACK_IMPORTED_MODULE_5__["BasicModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"]],
      exports: [_app_modules_manage_manage_questions_manage_questions_routing__WEBPACK_IMPORTED_MODULE_4__["ManageQuestionsRoutingModule"]]
  ...
  /***/
  function srcAppModulesManageManageQuestionsQuestionsQuestionsComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesManageManageQuestionsQuestionsQuestionsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _app_shared_basic_components_components_header_route_menu_light_header_route_menu_light_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! @app/shared/basic-components/components/header-route-menu-light/header-route-menu-light.component */
    "./src/app/shared/basic-components/components/header-route-menu-light/header-route-menu-light.component.ts");
    ...
    let QuestionsComponent = class QuestionsComponent {
      constructor(_activeRoute, _tableService, _cservice, _router) {
        ...
        this.isAsc = true;
        this.selectedId = [];
        this.isPractise = false; // this._router.routeReuseStrategy.shouldReuseRoute = () => true;
      }
      ...
      getQuestionList() {
        this.isLoading = true;
        this.subscription = this._tableService.getManageQuestionList(this.tableFilter, this.currentModule).subscribe(res => {
          this.questionList = res.questions;
          this.tableFilter = res.filter;
          this.isLoading = false;
          if (this.currentModule.moduleType == 'READING') for (const obj of this.questionList) {
      ...
      deleteList(data) {
        this.subscription = this._tableService.onDeleteQuestion(data.questionId, this.currentModule.moduleType.toLowerCase(), data.questionType).subscribe(res => {
          this.getQuestionList();
        });
      }
      ...
      onPractise(emit) {
        ...
        if (this.selectedId.length != 0 && this.isPractise == false) {
          ...
          this.subscription = this._tableService.onReadingPractise(this.currentModule.questionType, tempObj).subscribe(() => {
            // this.getQuestionList();
            // this._router.navigate([],
            //   {
            ...
            //     queryParamsHandling: 'merge',
            //   });
            this.isPractise = false; // this.header.setPractise=false;
          });
        }
      }
      ...
      onSelectedAll($event) {
        ...
        this.subscription = this._tableService.onReadingSelectedAll(this.currentModule.questionType, tempObj).subscribe(() => {
          this.getQuestionList();
        });
      }
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_app_shared_basic_components_components_header_route_menu_light_header_route_menu_light_component__WEBPACK_IMPORTED_MODULE_4__["HeaderRouteMenuLightComponent"], {
      static: false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _app_shared_basic_components_components_header_route_menu_light_header_route_menu_light_component__WEBPACK_IMPORTED_MODULE_4__["HeaderRouteMenuLightComponent"])], QuestionsComponent.prototype, "header", void 0);
    QuestionsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/manage/manage-questions/questions/questions.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./questions.component.css */
      "./src/app/modules/manage/manage-questions/questions/questions.component.css")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _app_core_http_serviceIndex__WEBPACK_IMPORTED_MODULE_3__["TableListService"], _app_core_http_serviceIndex__WEBPACK_IMPORTED_MODULE_3__["CommonService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], QuestionsComponent);
    /***/
  },
  ...
  /***/
  function srcAppModulesManageManageQuestionsResloversCommentResloverTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CommentResolver", function () {
    ...
    let CommentResolver = class CommentResolver {
      ...
      resolve(route) {
        let url = "writing/".concat(route.params['questionType'], "/comments");
    ...
    CommentResolver = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_core_http_detail_service__WEBPACK_IMPORTED_MODULE_2__["DetailService"]])], CommentResolver);
    /***/
  },
  ...
  /***/
  function srcAppModulesManageManageQuestionsResloversEssayStructureResloverTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EssayStructureResolver", function () {
      return EssayStructureResolver;
    });
    /* harmony import */
    ...
    EssayStructureResolver = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_core_http_detail_service__WEBPACK_IMPORTED_MODULE_2__["DetailService"]])], EssayStructureResolver);
    /***/
  },
  ...
  /***/
  function srcAppModulesManageManageQuestionsStructureStructureComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesManageManageQuestionsStructureStructureComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StructureComponent", function () {
    ...
    var _app_shared_models_WritingModel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @app/shared/models/WritingModel */
    ...
    let StructureComponent = class StructureComponent {
      ...
      getEssayStructure(res) {
        ...
        this.essayForm = this.formBuilder.group({
          answer: [res.answer.structureKeywords, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
          answer_number: [res.answer.maxKeyword, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
      ...
      onSaveOrUpdate() {
        this.isProgress = true;
        this.essay_structure = new _app_shared_models_WritingModel__WEBPACK_IMPORTED_MODULE_5__["Essay_Structure"](); // this.essay_structure.i = EssaySubStructure.create(string , number)

        this.essay_structure._id = this.essayStructureID; // For Introduction..

        this.essay_structure.answer = _app_shared_models_WritingModel__WEBPACK_IMPORTED_MODULE_5__["EssaySubStructure"].create(this.essayForm.get("answer").value ? this.essayForm.get("answer").value : "", this.essayForm.get("answer_number").value ? Number(this.essayForm.get("answer_number").value) : 0);
        this.subscription = this._saveService.onSaveStructure(this.essay_structure).subscribe(() => {
          this.goBack();
        });
      }
    ...
    StructureComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-structure',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./structure.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/manage/manage-questions/structure/structure.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./structure.component.css */
      "./src/app/modules/manage/manage-questions/structure/structure.component.css")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _app_core_http_save_service__WEBPACK_IMPORTED_MODULE_4__["SaveService"]])], StructureComponent);
    /***/
  },
...
//# sourceMappingURL=app-modules-manage-manage-questions-manage-questions-module-es5.a3a31d0b3df1bf35323c.js.map