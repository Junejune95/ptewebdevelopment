...
/* harmony import */ var _app_shared_models_SpeakingModel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @app/shared/models/SpeakingModel */ "./src/app/shared/models/SpeakingModel.ts");
...
let SpeakingQuestionComponent = class SpeakingQuestionComponent {
    ...
    onemitFile(data) {
        ...
        if (data.recoderStatus == "end") {
            ...
            if (this.isnonEvaluate) {
                this.recoder.isNoEvaluate = true;
                evaluate.isNoEvaluate = true;
            }
...
//# sourceMappingURL=default~app-modules-other-evaluate-other-evaluate-module~app-modules-other-question-module-other-que~ba6936d6-es2015.61d6601297476787b006.js.map