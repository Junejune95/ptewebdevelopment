(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-home-home-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesHomeHomeHomeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesHomeHomeRoutingMouduleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _app_modules_home_reslovers_home_reslover__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @app/modules/home/reslovers/home.reslover */
    ...
    HomeRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      providers: [_app_modules_home_reslovers_home_reslover__WEBPACK_IMPORTED_MODULE_3__["HometResolver"]]
    })], HomeRoutingModule);
    /***/
  },
  ...
  function srcAppModulesHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_modules_home_home_routing_moudule__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! @app/modules/home/home-routing.moudule */
    "./src/app/modules/home/home-routing.moudule.ts");
    /* harmony import */
    ...
    var lottie_web__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(lottie_web__WEBPACK_IMPORTED_MODULE_8__); // Import ng-circle-progress
    ...
    HomeModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _app_modules_home_home_routing_moudule__WEBPACK_IMPORTED_MODULE_4__["HomeRoutingModule"], _app_shared_basic_components_basic_module__WEBPACK_IMPORTED_MODULE_5__["BasicModule"], // Specify ng-circle-progress as an import
      ng_circle_progress__WEBPACK_IMPORTED_MODULE_6__["NgCircleProgressModule"].forRoot({}), ngx_lottie__WEBPACK_IMPORTED_MODULE_7__["LottieModule"].forRoot({
        player: playerFactory
      })],
      exports: [_app_modules_home_home_routing_moudule__WEBPACK_IMPORTED_MODULE_4__["HomeRoutingModule"]]
    })], HomeModule);
    /***/
  },
  ...
  /***/
  function srcAppModulesHomeHomeHomeComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "p.question-title,p.question-count,.question-progress-percent,.icon-content p,\n.plan-title,.reading>p,.listening>p,.right-text{\n    font-family: Lullabies;\n}\np {\n    margin-bottom: 10px;\n}\n.card {\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-orient: horizontal;\n    -webkit-box-direction: normal;\n            flex-direction: row;\n    -webkit-box-pack: justify;\n            justify-content: space-between;\n    box-shadow: var(--card-boxshadow);\n}\n/* ---------------------------------------------------\n    CARD LEFT CONTENT\n----------------------------------------------------- */\n.left-content {\n    width: 60%;\n}\np.question-title {\n    color: var(--text-fade-color);\n}\n/* ---------------------------------------------------\n    ICON CONTENT\n----------------------------------------------------- */\n.icon-content {\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n            flex-direction: column;\n    -webkit-box-align: center;\n            align-items: center;\n    -webkit-box-pack: center;\n            justify-content: center;\n    width: 40%;\n}\n.icon-content p {\n    font-weight: 500;\n}\n.question-icon {\n    width: 50%;\n    height: 50%;\n    margin-bottom: 6px;\n}\n.question-icon img {\n    width: 100%;\n    height: 100%;\n    -o-object-fit: contain;\n       object-fit: contain;\n}\n.speaking .question-icon img {\n    -webkit-filter: var(--speaking-filter-color);\n            filter: var(--speaking-filter-color);\n}\n.listening .question-icon img {\n    -webkit-filter: var(--listening-filter-color);\n            filter: var(--listening-filter-color);\n}\n.writing .question-icon img {\n    -webkit-filter: var(--writing-filter-color);\n            filter: var(--writing-filter-color);\n}\n.reading .question-icon img {\n    -webkit-filter: var(--reading-filter-color);\n            filter: var(--reading-filter-color);\n}\n.speaking p {\n    color: var(--speaking-color)\n}\n.listening p {\n    color: var(--listening-color)\n}\n.writing p {\n    color: var(--writing-color);\n}\n.reading p {\n    color: var(--reading-color);\n}\n/* \np.question-count {\n    color: var(--text-dark-color);\n} */\n/* ---------------------------------------------------\n    STUDY PLAN,Individual Mock Test,Prediction File\n----------------------------------------------------- */\nul {\n    width: 100%;\n    margin-bottom: 0;\n}\nli {\n    padding: 16px;\n    border-bottom: solid 1px #ececec;\n}\nli.title {\n    text-align: center;\n    FONT-WEIGHT: 600;\n    color: var(--text-dark-color);\n}\n.bar {\n    width: 6px;\n    background-color: var(--text-fade-color);\n    height: 40px;\n    border-radius: 5px;\n    display: inline-block;\n    margin-right: 10px;\n}\n.speaking .bar {\n    background-color: var(--speaking-color);\n    color: var(--speaking-color);\n}\n.listening .bar {\n    background-color: var(--listening-color);\n    color: var(--listening-color);\n}\n.reading .bar {\n    background-color: var(--reading-color);\n    color: var(--reading-color);\n}\n.writing .bar {\n    background-color: var(--writing-color);\n    color: var(--writing-color);\n}\n.speaking {\n    color: var(--speaking-color);\n}\n.listening {\n    color: var(--listening-color);\n}\n.reading {\n    color: var(--reading-color);\n}\n.writing {\n    color: var(--writing-color);\n}\n.question>div {\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-align: center;\n            align-items: center;\n}\nli.prediction-question {\n    display: -webkit-box;\n    display: flex;\n    flex-wrap: wrap;\n}\n.prediction-question>div {\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n    flex-direction: row;\n    -webkit-box-align: center;\n            align-items: center;\n    margin: 8px;\n    border-radius: 10px;\n    padding: 10px;\n    -webkit-box-pack: justify;\n            justify-content: space-between;\n}\n.prediction-question>.speaking,.mock-question>.speaking {\n    background-color: #d1ffd1;\n}\n.prediction-question>.listening,.mock-question>.listening {\n    background-color: #ffe1e7;\n}\n.prediction-question>.reading,.mock-question>.reading {\n    background-color: #d6f8ff;\n}\n.mock-question>div{\n    display: -webkit-box;\n    display: flex;\n    height: 105px;\n    -webkit-box-pack: justify;\n            justify-content: space-between;\n    padding: 10px;\n    border-radius: 10px;\n}\n.right-text{\n    background-color: var(--half-bg-color);\n    color: white;\n    text-transform: uppercase;\n    /* font-weight: 500; */\n    width: 100%;\n    /* font-size: 18px; */\n    padding: 20px;\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-align: center;\n            align-items: center;\n    cursor: pointer;\n    border-radius: 0px 14px 14px 0px;\n}\n.img {\n    width: 100px;\n    height: 80px;\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-align: center;\n            align-items: center;\n    -webkit-box-pack: center;\n            justify-content: center;\n}\n.uncheck-box {\n    border: solid 1px var(--text-fade-color);\n    height: 20px;\n    width: 20px;\n}\n@media only screen and (max-width: 760px) {\n    .prediction-question>div {\n        width:100%;\n    }\n}\n.prediction-question{\n    border-bottom: solid 1px #ebebeb;\n}\n.prediction-question:last-child{\n    border-bottom: unset;\n}\np.plan-title {\n    padding: 18px;\n    font-weight: 500;\n    border-bottom: solid;\n    border-bottom: solid 1px #ebebeb;\n    color: var(--text-fade-color);\n    text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppModulesHomeHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let HomeComponent = class HomeComponent {
      ...
      goToQBank(qb) {
        this._router.navigateByUrl("alchemist-academy/question-bank/".concat(qb));
      }

      goToStudyPlan(qb) {
        this._router.navigateByUrl("alchemist-academy/evaluate-question/study-plan/".concat(qb));
      }
    ...
    HomeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/home/home/home.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./home.component.css */
      "./src/app/modules/home/home/home.component.css")).default]
  ...
  /***/
  function srcAppModulesHomeResloversHomeResloverTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HometResolver", function () {
      return HometResolver;
    });
    /* harmony import */
    ...
    HometResolver = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_core_http_detail_service__WEBPACK_IMPORTED_MODULE_2__["DetailService"]])], HometResolver);
    /***/
  }
}]);
//# sourceMappingURL=modules-home-home-module-es5.207a3d3887cd587e0389.js.map