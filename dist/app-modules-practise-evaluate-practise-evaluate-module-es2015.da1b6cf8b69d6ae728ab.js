...
let SpeakingPractiseComponent = class SpeakingPractiseComponent {
    ...
    getAnswer(answer) {
        ...
        if (answer.isNoEvaluate) {
            ...
            // })
            this._service.onPractiseSpeakingEvaluate(answer, this.routeParam)
                .subscribe((res) => {
                this.scoreResult = res;
                this.scoreResult.questionType = answer.questionType;
...
//# sourceMappingURL=app-modules-practise-evaluate-practise-evaluate-module-es2015.da1b6cf8b69d6ae728ab.js.map