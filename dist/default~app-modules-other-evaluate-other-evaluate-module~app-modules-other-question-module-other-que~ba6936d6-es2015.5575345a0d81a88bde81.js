...
let SpeakingQuestionComponent = class SpeakingQuestionComponent {
    ...
    onemitFile(data) {
        ...
        if (data.recoderStatus == "end") {
            ...
            if (this.clickNoEvaluate)
                evaluate.isNoEvaluate = this.clickNoEvaluate;
...
//# sourceMappingURL=default~app-modules-other-evaluate-other-evaluate-module~app-modules-other-question-module-other-que~ba6936d6-es2015.5575345a0d81a88bde81.js.map